...
class KeywordExtractor:
    ...
    def compute_similarity(self, keyword_to_compare, keywords):
        # 핵심 역량 문장을 Flair Sentence로 변환하고 임베딩
        keyword_embedding = self.embed_text(keyword_to_compare)
    ...
    def run(self):
        # 1. 자기소개서 핵심 역량 입력
        keyword_to_compare = input("자기소개서에 드러내고 싶었던 역량을 작성해주세요 : ")
        ...
        top_related_keywords = self.compute_similarity(keyword_to_compare, keywords)

        print(f"\n'{keyword_to_compare}'과 연관된 상위 5개의 키워드:")
